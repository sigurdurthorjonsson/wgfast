...
On Sunday and Monday April 6 and 7 three workshops/side meetings will be held. **Note** that departure of the bus from Reykjavik is not until 8:30 on Sunday since there is much less traffic then. **Also note** that there is an event in the canteen of MFRI on Sunday, which will limit the access to ground floor facilities somewhat.
